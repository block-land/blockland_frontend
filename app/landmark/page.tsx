...
export default function LandmarkPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      map.on("mousemove", (e) => {
        // Guard: layers not ready until map style loads. Note: map.getStyle()
        // THROWS "Style is not done loading" if called before the style is
        // ready — so we must not call it. Checking getLayer() is safe and
        // sufficient: it returns undefined until the layer exists.
        if (!map.getLayer("sold-tiles-fill")) return;
