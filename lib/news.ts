...
export const DUMMY_NEWS: NewsItem[] = [
  {
    ...
    slug: "blockland-launches-usa-genesis-phase-the-coordinate-economy-is-born",
    content: [
  ...
  },
  {
    ...
    slug: "integrating-better-auth-and-supabase-inside-hono-runtime",
    content: [
  ...
  },
  {
    ...
    slug: "how-to-bid-on-coordinate-units-in-the-new-blockland-marketplace",
    content: [
  ...
  },
  {
    ...
    slug: "ecosystem-rewards-and-staking-what-you-need-to-know",
    content: [
